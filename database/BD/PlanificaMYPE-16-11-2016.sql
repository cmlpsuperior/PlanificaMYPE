...
START TRANSACTION;
USE `BDPlanificaMYPE`;
INSERT INTO `BDPlanificaMYPE`.`Empleado` ( `nombres`, `apellidoPaterno`, `apellidoMaterno`, `numeroDocumento`, `correo`, `estado`, `sueldo`, `licencia`, `fechaIngreso`, `fechaSalida`, `idCargo`, `idTipoDocumento`) VALUES ( 'Generico', 'Generico', 'Generico', '99999999', 'generico@correo.com', 'Activo', 0, NULL, '2016-11-01', NULL, 1, 1);
