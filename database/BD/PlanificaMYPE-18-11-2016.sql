...
CREATE TABLE IF NOT EXISTS `BDPlanificaMYPE`.`Viaje` (
  ...
  INDEX `FK_Viaje_TipoVehiculo_idx` (`idTipoVehiculo` ASC),
...
CREATE TABLE IF NOT EXISTS `BDPlanificaMYPE`.`DetalleViaje` (
  ...
  INDEX `FK_DetalleViaje_Pedido_idx` (`idPedido` ASC),
...
-- -----------------------------------------------------
-- Table `BDPlanificaMYPE`.`Usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `BDPlanificaMYPE`.`Usuario` (
  `idUsuario` INT NOT NULL AUTO_INCREMENT,
  `usuario` VARCHAR(15) NOT NULL,
  `contrasenia` VARCHAR(100) NOT NULL,
  `idEmpleado` INT NOT NULL,
  PRIMARY KEY (`idUsuario`),
  INDEX `FK_Usuario_Empleado_idx` (`idEmpleado` ASC),
...
CREATE UNIQUE INDEX `usuario_UNIQUE` ON `BDPlanificaMYPE`.`Usuario` (`usuario` ASC);
